    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">
        	<a href="student-activity-summarizing.php">Activity Summarizing</a>
        </li>
		                     ...
		                     $result = mysqli_query($mysqli,$sql);
		                      if (mysqli_num_rows($result) > 0) { 
		                         ...
		                         while($row = mysqli_fetch_assoc($result)) {
		                          ...
		                          $id = getIdViaCode($code,'activity_summarizing',$mysqli);
...
<script type="text/javascript">
	...
	function selectTest(id){    
      var id = id;            
      $('#dynamicTest').load('../snippet/student-summary-dynamic.php?id=' + id,function(){                              
      });                    
   }
