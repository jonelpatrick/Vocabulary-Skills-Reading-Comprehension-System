    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">
          <a href="student-quiz-vocabulary.php">Vocabulary Quiz</a>
        </li>
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                      ...
                      <?php
                        ...
                        $sql = "SELECT 
                                ...
                                FROM class_quiz
                                INNER JOIN class_list_student ON class_quiz.class_id = class_list_student.class_id
                                INNER JOIN class ON class_quiz.class_id = class.id
                                INNER JOIN section ON class.section_id = section.id
                                INNER JOIN subject ON class.subject_id = subject.id
                                WHERE class_list_student.student_id =7
                                AND quiz_type =  'Vocabulary'
                                GROUP BY quiz_code";
...
<script type="text/javascript">
  ...
  function selectQuiz(id){    
      var id = id;            
      $('#dynamicTest').load('../snippet/student-quiz-vocabulary-dynamic.php?id=' + id,function(){                              
      });                    
  }
